...
from prepareModel import prepareModel, prepareTrainingLoss, prepareTrainingOptimizer, prepareDensenetModelWithTXT
...
def mainDensenet():
    ...
    #PREPARE MODEL STEPS:
    print('Prepare model')
    model = prepareDensenetModelWithTXT(data, n_classes)
    ...
    plotLosses(history, 'densenet')
    plotAcc(history, 'densenet')
