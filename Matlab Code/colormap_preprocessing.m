...
saudaveis = '../../Imagens_TXT_Estaticas_Balanceadas_allData_menosValidacaoRuim/0Saudavel/';
...
%     saveas(gcf, folderSaudaveis)
    ...
    folderSaudaveis = strcat('../../Imagens_TXT_Estaticas_Balanceadas_allData_menosValidacaoRuim_rgb_DA/0Saudaveis/', nomeSaudaveis(i, :));
    py.numpy.save(folderSaudaveis, numpyRGB);
%     
     dataAugment(img, RGB, nomeSaudaveis, i, 2, 'saudaveis/', '0Saudaveis','Imagens_TXT_Estaticas_Balanceadas_allData_menosValidacaoRuim_rgb_DA')
%     %getting mean
%     I = img;
%     RGBParsed = RGB;
...
doentes = '../../Imagens_TXT_Estaticas_Balanceadas_allData_menosValidacaoRuim/1Doente/';
...
%     saveas(gcf, folderDoentes)
    ...
    numpyRGB = py.numpy.array(RGB);
    folderDoentes = strcat('../../Imagens_TXT_Estaticas_Balanceadas_allData_menosValidacaoRuim_rgb_DA/1Doentes/', nomeDoentes(i, :));
    py.numpy.save(folderDoentes, numpyRGB);
    
    dataAugment(img, RGB, nomeDoentes, i, 2, 'doentes/', '1Doentes', 'Imagens_TXT_Estaticas_Balanceadas_allData_menosValidacaoRuim_rgb_DA')
