...
# resultsPlotName = 'dataAugmentation_matlabPreprocessing_3camadas_ex7_comDropout_lr'
resultsPlotName = 'dataAugmentation_matlabPreprocessing_3camadas_ex7_comDropout'
experimentType = 7
